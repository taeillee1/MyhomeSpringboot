...
public class BoardController {
    ...
    public String formSubmit(@Valid Board board, BindingResult bindingResult, Authentication authentication){//@ModelAttribute 이것은 사용자가 요청시 전달하는 값을 오브젝트 형태로 매핑해주는것을 의미한다
